...
random_count = 8
read_these = ['stopdata1009.html', 'stopdata1010.html']

soup = BeautifulSoup(open('/home/bhh2/AllTheData/transportdata/stopdata/October17thData.html'), 'lxml')
...
with open('/home/bhh2/AllTheData/transportdata/stopdata/old_data_' + str(random_count) + '.json', 'w') as outfile:
